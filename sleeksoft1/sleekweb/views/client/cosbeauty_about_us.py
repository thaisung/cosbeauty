...
def cosbeauty_about_us(request):
    if request.method == 'GET':
        ...
        try:
            context['obj1'] = EC_about_us.objects.get(Order=1)
        except:
            context['obj1'] = {}
        ...
        return render(request, 'sleekweb/client/cosbeauty_about_us.html', context, status=200)
