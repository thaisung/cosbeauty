...
def cosbeauty_story_detail(request,slug):
    if request.method == 'GET':
        ...
        try:
            context['obj1'] = BlogPost.objects.get(Slug=slug)
        except:
            context['obj1'] = {}
        ...
        return render(request, 'sleekweb/client/cosbeauty_story_detail.html', context, status=200)
